namespace wutLua
{
	...
	public delegate string LuaChunkReader( IntPtr L, ref ReaderInfo data, ref uint size );
	...
	public class LuaLib
	{
		...
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		public static extern void lua_getfield( IntPtr luaState, int tableIndex, string key );
		public static void lua_getglobal( IntPtr luaState, string name )
		{
			lua_getfield( luaState, LuaIndices.LUA_GLOBALSINDEX, name );
		}
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		...
		{
			return ( lua_type( luaState, index ) <= 0 );
		}
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
...
//		public static extern IntPtr lua_newuserdata( IntPtr luaState, int size );
		...
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		public static extern void lua_pushstring( IntPtr luaState, string s );
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		...
		public static void lua_pushcsfunction( IntPtr luaState, LuaCSFunction func )
		{
		...
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		public static extern void lua_rawgeti( IntPtr luaState, int tableIndex, int i );
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		public static extern void lua_rawset( IntPtr luaState, int tableIndex );
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		public static extern void lua_rawseti( IntPtr luaState, int tableIndex, int i );
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		...
		{
			lua_setfield( luaState, LuaIndices.LUA_GLOBALSINDEX, name );
		}
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		...
		{
			lua_getfield( luaState, LuaIndices.LUA_REGISTRYINDEX, tableName );
		}
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		...
		//
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		public static extern void wutlua_newuserdata( IntPtr luaState, int value );
		[DllImport( LIBNAME, CallingConvention = CallingConvention.Cdecl )]
		public static extern int wutlua_rawuserdata( IntPtr luaState, int index );
